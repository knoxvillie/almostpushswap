...
/*   Updated: 2023/02/15 22:20:10 by kfaustin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/push_swap.h"

static void	check_int_limits(stack *a)
{
	int	i;
...
static void	check_reps(stack *a)
{
	long	*list;
	int		i;
...
static void	check_invalid_single_argv(char *str)
{
	char	**check;
	int		s;
	int		i;
...
static void	check_invalid_mult_argv(int argc, char **argv)
{
	int	s;
	int	i;
